...
import { IconClipboard, IconCopy, IconEye, IconFile, IconFilePath, IconImage, IconPin, IconPinOff, IconTrash2 } from "./icons";
...
type HistoryRowProps = {
  ...
  onCopyImagePath: (id: string) => void;
  ...
  return (
    ...
    >
      ...
      <div className="row-actions">
        ...
        {item.type === "image" ? (
          <button className="icon-button" type="button" title="复制图片路径" onClick={() => onCopyImagePath(item.id)}>
            <IconFilePath size={16} />
          </button>
        ) : null}
